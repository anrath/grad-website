# Graduation Website
A beautiful, feature rich, device friendly graduation website.  
_See [graduation.kasralekan.com](http://graduation.kasralekan.com/) for a demo. Use invite code `271117` to RSVP._
...
# Getting Started
1. `$ git clone https://github.com/rampatra/graduation-website.git` - clone this project to your computer
2. `$ cd graduation-website` - go inside the project directory
3. `$ npm install` - install dependencies
4. `$ npx gulp` - compile sass to css, minify js, etc.
5. That's it, open `index.html` file on your browser by just double-clicking on it.

# Documentation
I have written a 
[blog post describing all the features of this graduation website](https://blog.rampatra.com/graduation-website) and how to
...
my leisure time and this is one of them. Now that my graduation is over, I am open-sourcing the project. Hope you like it!
